...
const { courses, lastCourses, courseDetail, activities, lastActivities, activityDetail, news, lastNews, newsDetail, equipo, inscripcion, sendEmail } = require('../models/index.js'); // Importar las funciones con los métodos HTTP
