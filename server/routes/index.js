...
const { courses,lastCourses, courseDetail, activities, lastActivities, activityDetail, news, newsDetail, equipo } = require('../models/index.js'); // Importar las funciones con los metodos HTTP
